...
public class StudentArtifactDAO {
    ...
    public Integer[] getArifcatQuantiyAndID(int studentID) throws SQLException {
        ...
        try {
            ...
            while(resultSet.next()) {
                artifact[artifactID] = resultSet.getInt("id_artifact");
    ...
    public void getArtifactMetaData(int artifactID){
