...
public class IncubatorController implements HttpHandler {

    private AuthenticationController authenticationController;
    private StudentDAO studentDAO;


    public IncubatorController(AuthenticationController authenticationController) {
    ...
    public void handle(HttpExchange httpExchange) throws IOException {
        ...
        String response = "";
        System.out.println("HERE incubator");
